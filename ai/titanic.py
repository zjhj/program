...
def pretreatment(data):
    ...
    data.loc[data['Title'] == 'Rev', 'Title'] = 5
    data.loc[data['Title'] == 'Major', 'Title'] = 6
    data.loc[data['Title'] == 'Mlle', 'Title'] = 7
    data.loc[data['Title'] == 'Col', 'Title'] = 8
    data.loc[data['Title'] == 'Capt', 'Title'] = 9
    data.loc[data['Title'] == 'Jonkheer', 'Title'] = 10
    data.loc[data['Title'] == 'Lady', 'Title'] = 11
    data.loc[data['Title'] == 'Ms', 'Title'] = 12
    data.loc[data['Title'] == 'Sir', 'Title'] = 13
    data.loc[data['Title'] == 'Mme', 'Title'] = 14
    data.loc[data['Title'] == 'Don', 'Title'] = 15
    data.loc[data['Title'] == 'the Countess', 'Title'] = 16
